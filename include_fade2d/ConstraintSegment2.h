...
{
	CIS_CONFORMING_DELAUNAY=0,///< Deprecated
	CIS_CONSTRAINED_DELAUNAY=1, ///< The recommended insertion strategy
#if GEOM_PSEUDO3D==GEOM_TRUE
...
*
* It may be impossible to represent a point *exactly* on a line segment
